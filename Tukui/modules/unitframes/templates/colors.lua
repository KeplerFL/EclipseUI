...
T.oUF_colors = setmetatable({
	...
	runes = setmetatable({
			...
			[2] = T.Colors.happiness[2],
			[3] = T.Colors.happiness[3],
			[4] = T.Colors.happiness[4],
	}, {__index = oUF.colors.runes}),
	reaction = setmetatable({
		[1] = T.Colors.happiness[1], -- Hated
		[2] = T.Colors.happiness[2], -- Hostile
		[3] = T.Colors.happiness[3], -- Unfriendly
		[4] = T.Colors.happiness[4], -- Neutral
		[5] = T.Colors.happiness[5], -- Friendly
		[6] = T.Colors.happiness[6], -- Honored
		[7] = T.Colors.happiness[7], -- Revered
		[8] = T.Colors.happiness[8], -- Exalted	
